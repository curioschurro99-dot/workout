...
export function seedMealSuggestions(): MealSuggestion[] {
  return [
    {
      id: "tofu-scramble",
      name: "Tofu Scramble on Whole Grain Toast",
      mealType: "breakfast",
      ingredients: ["firm tofu", "turmeric", "spinach", "whole grain bread"],
      kcal: 320,
      protein: 24,
      carbs: 28,
      fat: 14,
    ...
    {
      id: "oatmeal-bowl",
      name: "Overnight Oats with Berries & Hemp Seeds",
      mealType: "breakfast",
      ingredients: ["rolled oats", "soy milk", "blueberries", "hemp seeds", "maple syrup"],
      kcal: 380,
      protein: 18,
      carbs: 48,
      fat: 14,
    ...
    },
    {
      ...
      mealType: "breakfast",
      ingredients: ["banana", "spinach", "soy milk", "peanut butter", "chia seeds"],
      kcal: 350,
      protein: 16,
      carbs: 42,
      fat: 16,
    ...
    },
    {
      ...
      mealType: "breakfast",
      ingredients: ["greek yogurt", "granola", "blueberries", "almonds"],
      kcal: 340,
      protein: 28,
      carbs: 30,
      fat: 12,
    ...
    },
    {
      ...
      mealType: "lunch",
      ingredients: ["lentils", "quinoa", "roasted sweet potato", "kale", "tahini dressing"],
      kcal: 450,
      protein: 22,
      carbs: 55,
      fat: 16,
    ...
    },
    {
      ...
      mealType: "lunch",
      ingredients: ["chickpeas", "avocado", "whole wheat wrap", "spinach", "lemon juice"],
      kcal: 420,
      protein: 16,
      carbs: 45,
      fat: 18,
    ...
    },
    {
      ...
      mealType: "lunch",
      ingredients: ["tofu", "brown rice", "broccoli", "edamame", "soy sauce"],
      kcal: 440,
      protein: 28,
      carbs: 50,
      fat: 14,
    ...
    },
    {
      ...
      mealType: "lunch",
      ingredients: ["chicken breast", "quinoa", "avocado", "kale", "olive oil"],
      kcal: 460,
      protein: 38,
      carbs: 32,
      fat: 18,
    ...
    },
    {
      ...
      mealType: "dinner",
      ingredients: ["chickpeas", "spinach", "coconut milk", "brown rice", "curry spices"],
      kcal: 480,
      protein: 20,
      carbs: 55,
      fat: 20,
    ...
    },
    {
      ...
      mealType: "dinner",
      ingredients: ["lentils", "whole wheat pasta", "tomato sauce", "nutritional yeast", "garlic"],
      kcal: 460,
      protein: 24,
      carbs: 60,
      fat: 10,
    ...
    },
    {
      ...
      mealType: "dinner",
      ingredients: ["tempeh", "quinoa", "kale", "avocado", "tahini"],
      kcal: 500,
      protein: 30,
      carbs: 40,
      fat: 22,
    ...
    },
    {
      ...
      mealType: "snack",
      ingredients: ["chickpeas", "tahini", "carrot sticks", "cucumber", "whole grain crackers"],
      kcal: 280,
      protein: 14,
      carbs: 30,
      fat: 14,
